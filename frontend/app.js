    ...
    resultEl.innerHTML = `
      <div class="score-card">
        ...
        <div class="detail-row">
          <span>Required experience: <strong>${data.experience.required_years == null ? "not specified in JD" : `${data.experience.required_years}${data.experience.required_years_upper != null ? `-${data.experience.required_years_upper}` : "+"}`}</strong>${data.experience.required_years != null ? " yrs" : ""}</span>
