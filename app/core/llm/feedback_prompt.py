...
def generate_feedback_summary(
    ...
    *,
    ...
    if "usage" in response:
        ...
        resolved_model = model or route(TaskType.CONVERSATIONAL_AGENT)
        record_llm_usage(resolved_model, response["usage"], provider=_infer_provider_from_model(resolved_model))
